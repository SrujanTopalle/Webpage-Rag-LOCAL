...
st.caption("This app allows you to chat with a webpage using local llama2 and RAG")
...
if webpage_url:
    ...
    qdrant_client = QdrantClient("http://localhost:6333")  # Ensure Qdrant is running locally
